...
测试现货私有WebSocket客户端的签名、认证和交易请求功能。
"""
...
class TestSpotPrivateWSClientSignature:
    """现货私有WS客户端签名测试"""
...
class TestSpotPrivateWSClientRequests:
    """现货私有WS客户端请求测试"""
...
class TestSpotPrivateWSClientAuth:
    """现货私有WS客户端认证测试"""
...
class TestSpotPrivateWSClientResponseHandling:
    """现货私有WS客户端响应处理测试"""
